...
(function($, window, undefined) {
  ...
  $.fn.isValid = function (language, conf, displayError) {
    ...
    var addErrorMessage = function (mess, $elem) {
      ...
      ignoreInputByClass = function ($elem) {
        return $elem.hasClass(conf.ignoreClass);
      };
    ...
    $form.find('input,textarea,select').filter(':not([type="submit"],[type="button"])').each(function () {
      ...
      if (!ignoreInput(elementName, elementType) && !ignoreInputByClass($elem) && (!isCheckboxOrRadioBtn || $.inArray(elementName, checkedInputs) < 0)) {
  ...
  $.formUtils = $.extend($.formUtils || {}, {
    ...
    defaultConfig: function () {
      return {
        ...
        ignoreClass: '', // Names of inputs not to be validated even though `validationRuleAttribute` containing the validation rules tells us to
